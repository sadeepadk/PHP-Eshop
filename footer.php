...
<body class="container-fluid object-fit-lg">
        ...
        <div class="col-12 text-md-start">
            <div class="row text-sm-center text-md-start">
                ...
                <div class="col-12 col-md-3 col-lg-3 mx-auto mt-3">
                    <h5 class="text-uppercase text-warning mb-4">NextGen</h5>
                    <p>Here we are the NextGen.lk&trade; to support you for accomplish your dessire by selling high
                        quality products.</p>
                </div>

                <div class="col-12 col-md-3 col-lg-2 mx-auto mt-3">
                    <p>Copyright &copy; 2024 NextGen All Rights Reserved.</p>
                </div>
                    ...
                    <div class="text-sm-center text-md-start">
                        ...
                        <ul class="list-unstyled list-inline">
                            ...
                            <li class="list-inline-item">
                                <a href="https://www.facebook.com" class="form-floating text-white">
                ...
                <div class="col-12 col-md-4 col-lg-3 mx-auto mt-3">
                    ...
                    <p><i class="bi bi-house-fill"></i> Pilimathalawa, Kandy, Sri Lanka</p>
                    <p><i class="bi bi-at"></i> nextgen@gmail.com</p>
                    <p><i class="bi bi-telephone-fill"></i> +94 812 356 356</p>
                    <p><i class="bi bi-printer-fill"></i> +94 813 356 356</p>
